...
export const translations: Record<LanguageCode, Translations> = {
  ...
  de: {
    ...
    dropSubtitle: 'oder klicken, um vom Gerät auszuwählen. Unterstützt PDF, JPG, PNG, WebP, SVG',
    processingLocal: '100% lokale clientseitige Verarbeitung',
    processingLocalDesc: 'Ihre Dateien verlassen niemals Ihren Computer oder Ihr Smartphone. Die Verarbeitung erfolgt vollständig im geschützten Browser-Speicher.',
    ...
    favorites: 'Favoriten',
    noFavorites: 'Noch keine Favoriten hinzugefügt. Klicken Sie auf den Stern bei einem Tool, um es hier anzupinnen!',
    clearHistory: 'Verlauf löschen',
    searchPlaceholder: 'Tools durchsuchen (z. B. PDF komprimieren, Bild skalieren)...',
    searchTools: 'Tools durchsuchen (Cmd+K)',
    recommendedTools: 'Empfohlene Aktionen für Ihre Datei',
    supportedFormats: 'Unterstützt PDF, JPG, PNG, WebP & mehr',
    processFiles: 'Jetzt verarbeiten',
    download: 'Ergebnis herunterladen',
    downloadZip: 'Alles als ZIP herunterladen',
    reset: 'Neu starten',
    fileDetails: 'Datei-Informationen',
    originalSize: 'Originalgröße',
    outputSize: 'Neue Größe',
    savings: 'Eingesparter Speicher',
    dimensions: 'Abmessungen',
    quality: 'Kompressionsqualität',
    rotation: 'Drehung',
    pages: 'Seiten',
    installApp: 'App installieren',
    installIos: 'Auf iOS installieren',
    offlineNotice: 'Offline-Modus aktiv — Alle Tools funktionieren auch ohne Internetverbindung.',
    language: 'Sprache',
    theme: 'Erscheinungsbild',
    lightMode: 'Hell',
    darkMode: 'Dunkel',
    systemMode: 'System',
    proNotice: 'Entwickelt für maximale Geschwindigkeit, null Serverkosten und weltweite Skalierbarkeit.',
    terms: 'Nutzungsbedingungen',
    about: 'Über PDF Image Studio',
    contact: 'Kontakt & Feedback',
    blog: 'Anleitungen & Artikel',
    readyToStart: 'Bereit, Ihre Dateien sicher zu optimieren?',
    noUploadsRequired: 'Keine Uploads. Keine Registrierung. Keine Wartezeit.',
    organize: 'Organisieren',
    optimize: 'Optimieren',
    convert: 'Konvertieren',
    security: 'Sicherheit & Datenschutz',
    findTool: 'Tool finden...',
    allToolsCategories: 'ALLE TOOLS & KATEGORIEN',
    clientSidePrivacy: '100% lokaler Datenschutz',
    privacy: 'Datenschutz',
    chooseFileBtn: 'PDF-Dateien auswählen',
    orDropHere: 'oder PDFs & Bilder hier ablegen',
    secureNotice: '100% Sicher & Privat — Dateien werden lokal im Browser verarbeitet',
    freeUnlimited: '100% Kostenlos & Unbegrenzt',
    zeroServerUploads: 'Keine Datei-Uploads auf Server',
    noRegistrationNeeded: 'Keine Registrierung erforderlich',
    featuredPdfSuite: 'Ausgewählte PDF-Suite',
    pdfOrganizerTitle: 'Visueller PDF-Seiten-Organisator',
    pdfOrganizerDesc: 'PDF-Seiten visuell per Drag & Drop neu anordnen, drehen, löschen, duplizieren und extrahieren. 100% privat im Browser.',
    launchPdfOrganizer: 'PDF-Organisator starten',
    featuredImageSuite: 'Ausgewählte Bild-Suite',
    imageSuiteTitle: 'Bild-Optimierer & Konverter',
    imageSuiteDesc: 'Fotos um bis zu 80% komprimieren, Größe anpassen, zwischen JPG/PNG/WebP konvertieren und Filter mit Live-Vorschau anwenden.',
    launchImageSuite: 'Bild-Suite starten',
    allPdfImageUtilities: 'Alle PDF- & Bild-Werkzeuge',
    selectToolToProcess: 'Wählen Sie ein Tool aus, um Ihre Dateien sicher im Speicher Ihres Browsers zu verarbeiten.',
    ...
    share: 'Teilen',
    copied: 'Kopiert',
    clientSideEngine: '100% Clientseitige Engine',
    zeroUploadsNoServer: 'Keine Uploads • Kein Remote-Server-Speicher',
    faqs: 'Häufig gestellte Fragen',
    faqSub: 'Detaillierte Antworten zur Funktionsweise und lokalen Ausführung.',
    relatedTools: 'Ähnliche Tools',
    relatedSub: 'Dokumente nahtlos weiter organisieren oder umwandeln.',
    viewAll: 'Alle anzeigen',
    flagshipUtility: 'HAUPTWERKZEUG',
    choosePdfToCompress: 'PDF zum Komprimieren auswählen',
    reducePdfDesc: 'PDF-Dateigröße reduzieren bei voller Lesbarkeit und Dokumenttreue.',
    choosePdfFile: 'PDF-Datei auswählen',
    selectedPdf: 'Ausgewählte PDF',
    changeFile: 'Datei ändern',
    selectCompressionProfile: 'Kompressionsstufe wählen',
    allToolsCatalog: 'Katalog aller Tools',
    confidentialityGuarantee: 'Vertraulichkeitsgarantie',
