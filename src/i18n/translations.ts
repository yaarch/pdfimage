...
export const translations: Record<LanguageCode, Translations> = {
  ...
  ar: {
    ...
    whyNuvio: 'لماذا PDF Image Studio؟',
    howItWorks: 'كيف يعمل؟',
    privacyTitle: 'خصوصية عبر الهيكلية، وليس مجرد وعود',
    privacyDesc: 'معظم المواقع ترفع مستنداتك وصورك إلى خوادم بعيدة. PDF Image Studio يعمل بالكامل محلياً داخل جهازك دون رفع أي بيانات.',
